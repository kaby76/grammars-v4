...
func NewSymbolTable() *SymbolTable {
	...
	st.define(newPredefinedSymbol("_Float16x", TypeSpecifier_))
	st.define(newPredefinedSymbol("_Float32x", TypeSpecifier_))
	st.define(newPredefinedSymbol("_Float64x", TypeSpecifier_))
	st.define(newPredefinedSymbol("_Float128x", TypeSpecifier_))
